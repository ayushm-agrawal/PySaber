# This code is taken from Coursera Neural Networks course to Load the Planar Data.
# This is just used for simplicity of getting a dataset for my neural network implementation
# All Rights Reserved by Coursera Inc LLC.
